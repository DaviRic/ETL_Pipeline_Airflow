...
def processed_fruit_excel(file_path, fruit_name):
    ...
    df = df[~df.iloc[:, 0].astype(str).str.contains("USDA|Excludes|Includes|Source|Consumers|The|It", na=False)]
    ...
    df_final["Vegetable"] = fruit_name

    return df_final

raw_fruit_path = "data/raw/vegetables"
processed_fruit_path = "datasets/processed_vegetables"
